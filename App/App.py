...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='luffy',db='cv')
...
def run():
    ...
    link = '<b>Built with 🤍 by<a href="https://github.com/s-sreedhar" style="text-decoration: none; color: #021659;"> The Boys</a></b>' 
    ...
    if choice == 'User':
        ...
        # Upload Resume
        st.markdown('''<h5 style='text-align: left; color: #023568;'> Upload Your Resume, And Get Smart Recommendations</h5>''',unsafe_allow_html=True)
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            Built with 🤍 by 
            <a href="https://github.com/s-sreedhar" style="text-decoration: none; color: grey;">The Boys</a> through 
            <a href="https://www.linkedin.com/in/ssreedhargoud" style="text-decoration: none; color: grey;">Streamlit Cloud</a>
        </p>
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            if ad_user == 'admin' and ad_password == 'admin':
                ...
                st.success("Welcome Admin ! Total %d " % values + " Users Have Used Our Tool so far: )")                
                ...
                st.subheader("**Pie-Chart for Users Experienced Level**")
